...
public class adminLoginDialog extends JDialog {
   ...
   public adminLoginDialog() {
      ...
      JLabel lblNewLabel_2 = (JLabel) labelcreator.create("\\uBE44\\uBC00\\uBC88\\uD638","굴림",12, 106, 391, 15);
      panel.add(lblNewLabel_2);
      
      JLabel label = (JLabel) labelcreator.create("\uC544\uC774\uB514","굴림",12, 22, 391, 15);
      panel.add(label);
      
      JButton button = (JButton) btncreator.create("\uAD00\uB9AC\uC790 \uB85C\uADF8\uC778","굴림",12, 194, 391, 40);
      ...
      JLabel labelLogin = (JLabel) labelcreator.createWithHorizontal("스타벅스 관리자 로그인","굴림",50, 170, 415, 26,12);
