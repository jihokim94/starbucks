...
//	 */
	...
	public ProductInfo() {
		...
		JLabel lblNewLabel = (JLabel) labelcreator.createWithHorizontal("\uC0C1\uD488 \uB9AC\uC2A4\uD2B8","HY견고딕", 12,10,165,49,13);
		...
		JLabel lbID =(JLabel) labelcreator.createWithHorizontal("\\uAD00\\uB9AC \\uBC88\\uD638","굴림",12,266,105, 18,13);
		pnSub.add(lbID);
		
		JLabel label = (JLabel) labelcreator.createWithHorizontal("\uC0C1\uD488\uBA85","굴림",12,314,105, 18,13);
		pnSub.add(label);
		
		setTxtField(txtName,  311, 128);
		pnSub.add(txtName);
		
		JLabel label_1 = (JLabel) labelcreator.createWithHorizontal("\uCE74\uD14C\uACE0\uB9AC","굴림",12,360,105, 18,13);
		pnSub.add(label_1);
		
		JLabel label_2 = (JLabel) labelcreator.createWithHorizontal("\uC0AC\uC9C4\uD30C\uC77C\uACBD\uB85C","굴림",12,405,105, 18,13);
		pnSub.add(label_2);
		
		setTxtField(txtImagePath, 404,105);
		pnSub.add(txtImagePath);
		
		JLabel label_3 = (JLabel) labelcreator.createWithHorizontal("\uAC00\uACA9","굴림",12,457,105, 18,13);
		pnSub.add(label_3);
		
		setTxtField(txtPrice, 454,128);
		pnSub.add(txtPrice);
		
		JLabel label_4 = (JLabel) labelcreator.createWithHorizontal("\uC720\uBB34","굴림",12,504,105, 18 ,13);
		pnSub.add(label_4);
		...
		JLabel label_5 = (JLabel) labelcreator.createWithHorizontal("\uCD9C\uC2DC\uC77C","굴림",12,541,105, 18,13);
		pnSub.add(label_5);
