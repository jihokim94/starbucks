...
//	 */
	...
	private void makePnSub(JSplitPane splitPane) {
		...
		JLabel lbID = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\\uAD00\\uB9AC \\uBC88\\uD638"),266,105, 18,13 ), "굴림",12,Font.BOLD)).getLabel();
		pnSub.add(lbID);
		
		JLabel lb_productName = 
				new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uC0C1\uD488\uBA85"),314,105, 18,13 ), "굴림",12,Font.BOLD)).getLabel();
		...
		JLabel lb_category = 
				new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uCE74\uD14C\uACE0\uB9AC"),360,105, 18,13 ), "굴림",12,Font.BOLD)).getLabel();
		pnSub.add(lb_category);
		
		JLabel lb_imagePath = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uC0AC\uC9C4\uD30C\uC77C\uACBD\uB85C"),405,105, 18,13), "굴림",12,Font.BOLD)).getLabel();
		pnSub.add(lb_imagePath);
		
		setTxtField(txtImagePath, 404,105);
		pnSub.add(txtImagePath);
		
		JLabel lb_price = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uAC00\uACA9"),457,105, 18,13), "굴림",12,Font.BOLD)).getLabel();
		...
		JLabel lb_presence = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uC720\uBB34"),504,105, 18 ,13), "굴림",12,Font.BOLD)).getLabel();
		...
		JLabel lb_realeaseDate = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uCD9C\uC2DC\uC77C"),541,105, 18,13), "굴림",12,Font.BOLD)).getLabel();
	...
	private void makePnMain(JSplitPane splitPane) {
		...
		JLabel lb_productList = new LabelHorizon(new LabelFont(new BoundDecorator(new JLabel("\uC0C1\uD488 \uB9AC\uC2A4\uD2B8"),10,165,49,13), "굴림",12,Font.BOLD)).getLabel();
