...
//	 */
	...
	public ProductInfo() {
		...
		JLabel lblNewLabel = setLabel("\uC0C1\uD488 \uB9AC\uC2A4\uD2B8", 12,10,165,49,"HY견고딕");
		...
		JLabel lbID = setLabel("\\uAD00\\uB9AC \\uBC88\\uD638",12,266,105, 18,"굴림");
		pnSub.add(lbID);
		
		JLabel label = setLabel("\uC0C1\uD488\uBA85",12,314,105, 18,"굴림");
		pnSub.add(label);
		
		setTxtField(txtName,  311, 128);
		pnSub.add(txtName);
		
		JLabel label_1 = setLabel("\uCE74\uD14C\uACE0\uB9AC",12,360,105, 18,"굴림");
		pnSub.add(label_1);
		
		JLabel label_2 = setLabel("\uC0AC\uC9C4\uD30C\uC77C\uACBD\uB85C",12,405,105, 18,"굴림");
		pnSub.add(label_2);
		
		setTxtField(txtImagePath, 404,105);
		pnSub.add(txtImagePath);
		
		JLabel label_3 = setLabel("\uAC00\uACA9",12,457,105, 18,"굴림");
		pnSub.add(label_3);
		
		setTxtField(txtPrice, 454,128);
		pnSub.add(txtPrice);
		
		JLabel label_4 = setLabel("\uC720\uBB34",12,504,105, 18,"굴림" );
		pnSub.add(label_4);
		...
		JLabel label_5 = setLabel("\uCD9C\uC2DC\uC77C",12,541,105, 18,"굴림");
		pnSub.add(label_5);
