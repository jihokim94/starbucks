		...
		if ( txtFirstCardNo != null ) {
			...
			if ( txtFirstCardNo.getText().equals("9411") ||
					txtFirstCardNo.getText().equals("9441") || 
					 txtFirstCardNo.getText().equals("9463")) { // 농협
